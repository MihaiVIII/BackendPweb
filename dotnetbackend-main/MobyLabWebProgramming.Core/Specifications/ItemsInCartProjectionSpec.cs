...
/// </summary>
public sealed class ItemsInCartProjectionSpec : BaseSpec<ItemsInCartProjectionSpec, Item_In_Carts, ItemInCartDTO>
{
    /// <summary>
    /// This is the projection/mapping expression to be used by the base class to get UserDTO object from the database.
    /// </summary>
    protected override Expression<Func<Item_In_Carts, ItemInCartDTO>> Spec => e => new()
    {
        Id = e.Id,
        Quantity = e.Quantity,
        ItemID = e.ItemId,
